...
_SHARED_HIDDEN_IMPORTS: tuple[str, ...] = (
    ...
    "backend.engine.families.longcat.bundle_load",
    "backend.engine.families.longcat.transformer_mlx",
    "backend.engine.families.longcat.dit_blocks",
    "backend.engine.families.longcat.dit_attention",
    "backend.engine.families.longcat.dit_rope",
    "backend.engine.families.longcat.vae_mlx",
    "backend.engine.families.longcat.text_encoder_mlx",
    "backend.engine.families.longcat.conditioning",
    ...
    "backend.engine.families.longcat_avatar.bundle_load",
