"""VAE 编码器 — SD AutoencoderKL encoder，参考 mflux z_image / flux2 VAE。"""
from __future__ import annotations
from typing import Any
from backend.engine.runtime._base import RuntimeContext
from backend.engine.common._vae import ResnetBlock, SpatialAttention, _to_nhwc, _to_nchw


class Downsample:
    """2x 下采样：stride=2 Conv2d。"""
    def __init__(self, in_ch: int, ctx: RuntimeContext):
        self.ctx = ctx
        self.conv = ctx.Conv2d(in_ch, in_ch, 3, stride=2, padding=1)
...
class VAEEncoder:
    """SD AutoencoderKL Encoder — 与 mflux z-image/flux2 VAE encoder 一致。"""
    ...
    def load_weights(self, weights: list[tuple[str, Any]], strict: bool = False):
        ...
        for key, tensor in weights:
            ...
            import mlx.core as mx
            # Conv2d weight: diffusers (O, I, kH, kW) → MLX NHWC (O, kH, kW, I)
