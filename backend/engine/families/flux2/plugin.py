...
def build_flux2_plugin(
    ...
    *,
    ...
    spec = family_spec_from_config("flux2", config, media="image")
    return FamilyPlugin(
        family_id="flux2",
        spec=spec,
...
def register_flux2_plugin() -> None:
    register_family("flux2", build_flux2_plugin)
