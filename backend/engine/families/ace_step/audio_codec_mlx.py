...
from backend.engine.families.ace_step.condition_mlx import _ConditionEncoderLayer
...
class _AttentionPoolerMLX(nn.Module):
    ...
    def __call__(self, x: mx.array) -> mx.array:
        ...
        from backend.engine.common.attention import build_window_with_padding_bias
