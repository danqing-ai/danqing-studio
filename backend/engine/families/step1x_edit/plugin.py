"""Step1X-Edit FamilyPlugin factory."""
...
def build_step1x_edit_plugin(
    ...
    *,
    ...
    config = get_config_class("step1x_edit")()
    spec = family_spec_from_config("step1x_edit", config, media="image")
    return FamilyPlugin(
        family_id="step1x_edit",
        spec=spec,
        backbone=ImagePluginBackbone(spec),
    )


def register_step1x_edit_plugin() -> None:
    register_family("step1x_edit", build_step1x_edit_plugin)
