"""RRDBNet — Real-ESRGAN x4plus (MLX NHWC)."""
from __future__ import annotations

import mlx.core as mx
import mlx.nn as nn

from backend.engine.families.esrgan.spatial_mlx import interpolate_nearest_nhwc, pixel_unshuffle_nhwc
...
class RRDBNet(nn.Module):
    """Real-ESRGAN RRDBNet; NHWC in/out, pixel values in [0, 1]."""
    ...
    def __init__(
        ...
        *,
        ...
        self.conv_first = _conv(in_ch, num_feat)
        for i in range(num_block):
            setattr(self, f"body_{i}", RRDB(num_feat, num_grow_ch))
        ...
        self.conv_last = _conv(num_feat, 3)
    ...
    def __call__(self, x: mx.array) -> mx.array:
        ...
        for i in range(self.num_block):
            body_feat = getattr(self, f"body_{i}")(body_feat)
