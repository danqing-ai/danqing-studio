"""MLX-native weight load + mapping (SeedVR2 bundle layout only)."""
...
from backend.engine.seedvr2.runtime.constants import DQ_WEIGHT_DL_CACHE
from backend.engine.seedvr2.runtime.common.resolution.path_resolution import PathResolution
from backend.engine.seedvr2.runtime.common.weights.loading.loaded_weights import LoadedWeights, MetaData
from backend.engine.seedvr2.runtime.common.weights.loading.weight_definition import ComponentDefinition
from backend.engine.seedvr2.runtime.common.weights.mapping.weight_mapper import WeightMapper

if TYPE_CHECKING:
    from backend.engine.seedvr2.runtime.common.weights.loading.weight_definition import WeightDefinitionType
...
class WeightLoader:
    ...
    def _load_weights_file(file_path: Path, loading_mode: str) -> dict[str, mx.array]:
        ...
        raise ValueError(f"Unsupported loading mode for SeedVR2 loader: {loading_mode!r}")
