...
from backend.engine.seedvr2.runtime.callbacks.callback import AfterLoopCallback, BeforeLoopCallback, InLoopCallback, InterruptCallback

if TYPE_CHECKING:
    from backend.engine.seedvr2.runtime.callbacks.generation_context import GenerationContext
